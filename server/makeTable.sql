SET search_path TO Z3LMPV,public;
...
CREATE TABLE flights (
    ...
    seats_booked integer NOT NULL,
  	movie char(3) NOT NULL,
  	meal char(3) NOT NULL,
...
CREATE TABLE ticket(
    ...
    book_ref character(6) NOT NULL,
    passenger_name character(30) NOT NULL,
...
CREATE TABLE arrival_info (
    ...
    flight_id integer NOT NULL,
  	...
  	PRIMARY KEY (ticket_no, flight_id),
  	CONSTRAINT "arrival_info_ticket_flight_fkey" FOREIGN KEY (ticket_no, flight_id) REFERENCES ticket_flights(ticket_no, flight_id)
);
